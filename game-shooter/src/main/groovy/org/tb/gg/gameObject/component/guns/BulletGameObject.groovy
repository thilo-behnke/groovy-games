...
class BulletGameObject extends BaseGameObject implements TimePerishable {
...
//        return CollisionPerishable.super.shouldPerish() || OutOfBoundsPerishable.super.shouldPerish()
//    }
}
